...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "host-tracker-impl";
    private final String namespace = "urn:opendaylight:alto:dummy-data-listener-impl";
    private final String revision = "2014-05-28";
    private final String resourcePath = "/META-INF/yang/dummy-data-listener-impl.yang";
